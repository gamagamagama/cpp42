...
/*   Updated: 2025/11/19 10:02:00 by mgavorni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "(constructor) ClapTrap constructor called" << std::endl;
}

ClapTrap::~ClapTrap()
{
    std::cout << "(destructor) ClapTrap destructor called" << std::endl;
}
